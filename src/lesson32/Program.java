    ...
    public static void main(String[] args) {
        ...
        switch (res) {
            ...
            case 1:
                ...
                break;
            default:
                System.out.println("Два учебных заведения одинаковы");
                break;
        }
        ...
        Collections.sort(list,nameCompare);  // сортировка по имени
    ...
    public int compare(University o1, University o2) {
        if (o1.getNum_of_students() == o2.getNum_of_students())
            return 0;
                ...
                o1.getNum_of_students() > o2.getNum_of_students() ? 1 : -1;
    }
}
