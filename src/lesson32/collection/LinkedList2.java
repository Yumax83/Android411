...
public class LinkedList2 {
    public static void main(String[] args) {
        ...
        System.out.println("Проверка на пусто список: " + stLL.isEmpty());


        ListIterator<Student> listIterator = stLL.listIterator();
        System.out.println("Итерация в прямом направлении");
        while (listIterator.hasNext()) {
            System.out.println("Индекс текущего элемента = " + listIterator.nextIndex() + ", элемент = " + listIterator.next());
        }
        System.out.println("Итерация в обратном направлении");
        while (listIterator.hasPrevious()) {
            System.out.println("Индекс текущего элемента = " + listIterator.previousIndex() + ", элемент = " + listIterator.previous());
        }
    }
}
